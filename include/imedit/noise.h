...
namespace imedit
{
    ...
    T pbrtPerlinNoise(T x, T y, T z)
    {
        ...
        T g100 = gradient(xip1, yIndex, zIndex, dxm1, dy, dz);
        T g010 = gradient(xIndex, yip1, zIndex, dx, dym1, dz);
        T g001 = gradient(xIndex, yIndex, zip1, dx, dy, dym1);
        T g110 = gradient(xip1, yip1, zIndex, dxm1, dym1, dz);
        T g101 = gradient(xip1, yIndex, zip1, dxm1, dy, dzm1);
        T g011 = gradient(xIndex, yip1, zip1, dx, dym1, dzm1);
        T g111 = gradient(xip1, yip1, zip1, dxm1, dym1, dzm1);
        T g000 = gradient(xIndex, yIndex, zIndex, dx, dy, dz);
